...
function Clock() {
    ...
    const stringDay = new Intl.DateTimeFormat('en-US', options).format(date); // День недели на английском

    const optionsMonth: { month: 'long' } = { month: 'long' };
    const stringMonth = new Intl.DateTimeFormat('en-US', optionsMonth).format(date); // Месяц на английском
    return (
